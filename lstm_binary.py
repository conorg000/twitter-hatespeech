from data_handler import get_data_binary
import argparse
import os
...
if __name__ == "__main__":
    ...
    # Save model
    model.save('models/lstm_binary_random_dim200_epoch10_batch128.h5')
    
    # save embeddings
    embeddings = model.layers[0].get_weights()[0]
    np.save('models/EMBEDDINGS_lstm_binary_random_dim200_epoch10_batch128.npy', embeddings)
